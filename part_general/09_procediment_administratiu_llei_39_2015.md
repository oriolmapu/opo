...
```mermaid
graph TD
    Interessats["CONDICIÓ D'INTERESSAT (Art. 4 LPACAP)"]
    
    A["a) Titulars de drets o interessos legítims individuals o col·lectius que PROMOUEN el procediment."]
    B["b) Els qui, sense haver iniciat el procediment, tenen DRETS que poden resultar afectats per la decisió."]
    C["c) Aquells els INTERESSOS LEGÍTIMS dels quals puguin resultar afectats i es PERSONIN abans de la resolució definitiva."]
...
```mermaid
graph LR
    Fases["FASES DEL PROCEDIMENT ADMINISTRATIU (Arts. 54 - 95 LPACAP)"]
    
    Iniciacio["1. INICIACIÓ<br/>(D'ofici o a sol·licitud)"]
    Ordenacio["2. ORDENACIÓ<br/>(Expedient electrònic i impuls)"]
    Instruccio["3. INSTRUCCIÓ<br/>(Al·legacions, proves, informes, audiència)"]
    Finalitzacio["4. FINALITZACIÓ<br/>(Resolució, desistiment, caducitat, conveni)"]

    Fases --> Iniciacio
    Iniciacio --> Ordenacio
    Ordenacio --> Instruccio
    Instruccio --> Finalitzacio
```
...
```mermaid
graph TD
    Silenci["EL SILENCI ADMINISTRATIU"]
    
    Solicitud["PROCEDIMENTS INICIATS A SOL·LICITUD (Art. 24)"]
    Ofici["PROCEDIMENTS INICIATS D'OFICI (Art. 25)"]
    
    Silenci --> Solicitud
    Silenci --> Ofici
    
    Solicitud --> ReglaPositiu["REGLA GENERAL: SILENCI ESTIMATORI (Positiu)<br/>Té a tots els efectes la consideració d'acte administratiu finalitzador."]
    Solicitud --> ExcepcionsNegatiu["EXCEPCIONS: SILENCI DESESTIMATORI (Negatiu)<br/>1. Norma amb rang de llei o dret de la UE.<br/>2. Dret de petició (art. 29 CE).<br/>3. Transferència de facultats de domini públic o servei públic.<br/>4. Activitats que puguin danyar el medi ambient.<br/>5. Procediments de responsabilitat patrimonial.<br/>6. Procediments d'impugnació d'actes i recursos."]
    
    Ofici --> Favorable["Efectes favorables / reconeixement de drets:<br/>SILENCI DESESTIMATORI (Negatiu)"]
    Ofici --> Desfavorable["Procediments de gravamen o sancionadors:<br/>CADUCITAT I ARXIVAMENT DE L'EXPEDIENT"]
```

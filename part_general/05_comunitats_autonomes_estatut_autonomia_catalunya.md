...
```mermaid
graph TD
    EAC["ESTATUT D'AUTONOMIA DE CATALUNYA (LO 6/2006 - 223 Articles)"]
    
    TP["Títol Preliminar (Arts. 1 - 14)"]
    T1["Títol I: Drets, deures i principis rectors (Arts. 15 - 54)"]
    T2["Títol II: De les institucions (Arts. 55 - 94)"]
    T3["Títol III: Del poder judicial a Catalunya (Arts. 95 - 109)"]
    T4["Títol IV: De les competències (Arts. 110 - 173)"]
    T5["Títol V: Relacions institucionals de la Generalitat (Arts. 174 - 200)"]
    T6["Títol VI: Del finançament de la Generalitat (Arts. 201 - 221)"]
    T7["Títol VII: De la reforma de l'Estatut (Arts. 222 - 223)"]
...
graph TD
    subgraph INSTITUCIONS_GENERALITAT["INSTITUCIONS DE LA GENERALITAT DE CATALUNYA (Art. 2.2 EAC)"]
        ...
        Govern["EL GOVERN DE LA GENERALITAT<br/>(Arts. 68 - 75 EAC)"]
        
        subgraph ALTRES_INSTITUCIONS["Altres Institucions Estatutàries rellevants (Arts. 76 - 82 EAC)"]
            CGE["Consell de Garanties Estatutàries (Art. 76)"]
            SG["Síndic de Greuges (Art. 78)"]
            SC["Sindicatura de Comptes (Art. 80)"]
            CAC["Consell de l'Audiovisual de Catalunya (Art. 82)"]
        end
    end
...
```mermaid
graph TD
    Iniciativa["INICIATIVA DE REFORMA (Art. 222.1 EAC)<br/>- 1/5 part dels Diputats del Parlament<br/>- El Govern de la Generalitat<br/>- Les Corts Generals<br/>- 20% dels Plens municipals (majoria del cens)"]
    
    AprovacioParlament["Aprovació pel PARLAMENT DE CATALUNYA<br/>Majoria de DOS TERÇOS (2/3) dels seus membres"]
    
    AprovacioCorts["Aprovació per les CORTS GENERALS<br/>mitjançant LLEI ORGÀNICA"]
    
    Referendum["REFERÈNDUM DEL POBLE DE CATALUNYA<br/>Ratificació preceptiva i vinculant"]
    
    Sancio["Sanció i Promulgació pel Rei"]
    
    Iniciativa --> AprovacioParlament
    AprovacioParlament --> AprovacioCorts
    AprovacioCorts --> Referendum
    Referendum --> Sancio
```

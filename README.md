...
| **25** | Catàleg de dades obertes i reutilització d'informació pública. | `part_especifica/bloc1_administracio_publica/25_cataleg_dades_obertes_reutilitzacio.md` | ⚪ Pendent |
| **26** | Impacte de les TIC en la democràcia. Portals de participació i xarxes socials. | `part_especifica/bloc1_administracio_publica/26_impacte_tic_democracia_portals_participacio_xarxes.md` | ⚪ Pendent |
...
| Núm. | Tema | Fitxer | Estat |
| :---: | :--- | :--- | :---: |
| **28** | Serveis de directoris actius i gestió de recursos. | `part_especifica/bloc2_identificacio_signatura/28_directoris_actius_gestio_recursos.md` | ⚪ Pendent |
| **29** | Polítiques de mots de pas i autentificació de doble factor (2FA/MFA). | `part_especifica/bloc2_identificacio_signatura/29_politiques_mots_de_pas_autentificacio_doble_factor.md` | ⚪ Pendent |
| **30** | Signatura electrònica: certificats digitals, PKI, Smart Cards, DNIe i biometria. | `part_especifica/bloc2_identificacio_signatura/30_signatura_electronica_certificats_pki_dnie_biometria.md` | ⚪ Pendent |
